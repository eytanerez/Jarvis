...
private enum SettingsTab: String, CaseIterable, Identifiable {
    ...
    var group: SettingsTabGroup {
        switch self {
        case .general, .jarvis, .appearance:                                 return .core
    ...
    var title: String {
        ...
        case .jarvis: return String(localized: "Jarvis")
...
struct SettingsView: View {
    ...
    private func detailView(for tab: SettingsTab) -> some View {
        ...
        case .jarvis:
            JarvisSettingsView(model: JarvisAssistantBridge.shared.model, embedded: true)
